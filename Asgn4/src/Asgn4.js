...
function lookAround(ev) {
  g_globalAngle[0] -= ev.movementX * 0.1;
  g_globalAngle[1] -= ev.movementY * 0.1;

  if (g_globalAngle[0] >= 360) {
    g_globalAngle[0] -= 360;
  } else if (g_globalAngle[0] < 0) {
    g_globalAngle[0] += 360;
  }

  if (g_globalAngle[1] >= 360) {
    g_globalAngle[1] -= 360;
  } else if (g_globalAngle[1] < 0) {
    g_globalAngle[1] += 360;
  }
  renderAllShapes();
}
