...
function handleSpecialEvent() {
  ...
  // Draw the S
  drawTriangle([0.16, 0.24, 0.16, 0.16, 0.00, 0.16]);
  drawTriangle([0.16, 0.24, 0.00, 0.16, 0.00, 0.24]);
  drawTriangle([0.00, 0.20, 0.00, 0.12, -0.08, 0.12]);
  drawTriangle([-0.08, 0.12, 0.00, 0.12, 0.00, 0.04]);
  drawTriangle([0.00, 0.04, 0.00, 0.08, 0.08, 0.04]);
  drawTriangle([0.08, 0.04, 0.00, 0.04, 0.08, -0.04]);
  drawTriangle([0.08, 0.04, 0.08, -0.04, 0.12, -0.04]);
  drawTriangle([0.12, -0.04, 0.08, -0.04, 0.08, -0.12]);
  drawTriangle([0.08, -0.12, 0.12, -0.04, 0.16, -0.12]);
  drawTriangle([0.16, -0.12, 0.08, -0.12, 0.12, -0.20]);
  drawTriangle([0.12, -0.20, 0.08, -0.12, 0.04, -0.20]);
  drawTriangle([0.04, -0.20, 0.12, -0.20, 0.00, -0.28]);
  drawTriangle([0.00, -0.28, -0.04, -0.20, 0.04, -0.20]);
  drawTriangle([-0.08, 0.12, -0.04, 0.24, 0.00, 0.24]);
  drawTriangle([0.0, 0.24, -0.08, 0.12, 0.00, 0.20]);
  drawTriangle([0.0, 0.24, -0.08, 0.12, 0.00, 0.20]);
  drawTriangle([0.00, 0.12, 0.00, 0.08, 0.08, 0.04]);

  // Draw the 2
  drawTriangle([0.24, 0.20, 0.32, 0.24, 0.48, 0.16]);
  drawTriangle([0.24, 0.20, 0.28, 0.16, 0.48, 0.16]);
  drawTriangle([0.48, 0.16, 0.36, 0.16, 0.44, 0.04]);
  drawTriangle([0.48, 0.16, 0.40, -0.08, 0.52, 0.00]);
  drawTriangle([0.52, 0.00, 0.44, -0.16, 0.40, -0.08]);
  drawTriangle([0.40, -0.08, 0.44, -0.16, 0.24, -0.20]);
  drawTriangle([0.24, -0.20, 0.20, -0.24, 0.24, -0.28]);
  drawTriangle([0.24, -0.28, 0.24, -0.20, 0.40, -0.28]);
  drawTriangle([0.24, -0.20, 0.44, -0.16, 0.32, -0.24]);
  drawTriangle([0.32, -0.24, 0.56, -0.20, 0.56, -0.24]);
  drawTriangle([0.56, -0.24, 0.56, -0.28, 0.32, -0.24]);
  drawTriangle([0.32, -0.24, 0.40, -0.28, 0.56, -0.28]);
}
